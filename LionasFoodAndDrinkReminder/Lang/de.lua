...
-- notification
ZO_CreateStringId("LIO_FADR_NEAR_EXPIRE_HOUR_MIN", "Die Wirkung der Mahlzeit läuft in <<1>>h <<2>>min aus.")
ZO_CreateStringId("LIO_FADR_NEAR_EXPIRE_MIN", "Die Wirkung der Mahlzeit läuft in <<1>>min aus.")
ZO_CreateStringId("LIO_FADR_NEAR_EXPIRE_CLOSED", "Die Wirkung der Mahlzeit läuft bald aus.")
...
ZO_CreateStringId("LIO_FADR_NOTIFY_ONLY_IN_DUNGEON_TITLE", "Meldungen nur innerhalb Verlies")
ZO_CreateStringId("LIO_FADR_NOTIFY_ONLY_IN_DUNGEON_TOOLTIP", "Wenn du nur über den Zustand der Mahlzeit in einem Verlies informiert werden möchtest, aktiviere diese Einstellung.")
ZO_CreateStringId("LIO_FADR_ENABLE_NOTIFY_TO_CHAT_TITLE", "Geben Sie zum Chat bekannt")
ZO_CreateStringId("LIO_FADR_ENABLE_NOTIFY_TO_CHAT_TOOLTIP", "Wenn Sie ermöglichen, um über den Staat der Mahlzeit bekannt zu geben, um zu plaudern, überprüfen Sie es bitte.")
